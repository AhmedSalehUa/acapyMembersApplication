...
public class JasonCostsReponser extends  AsyncTask<String, Void, String> {
    private static final String LOG_TAG = JasonCostsReponser.class.getName();
    ...
    public static void setFinish(boolean finish) {
        JasonCostsReponser.finish = finish;
    }
