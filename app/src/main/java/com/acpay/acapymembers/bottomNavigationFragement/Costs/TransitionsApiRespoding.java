...
public class TransitionsApiRespoding extends  AsyncTask<String, Void, String> {
    private static final String LOG_TAG = TransitionsApiRespoding.class.getName();
    ...
    public static void setFinish(boolean finish) {
        TransitionsApiRespoding.finish = finish;
    }
    ...
    public TransitionsApiRespoding() {
