...
public class JasonOrderNumsReponser extends  AsyncTask<String, Void, String> {
    private static final String LOG_TAG = JasonOrderNumsReponser.class.getName();
    ...
    public static void setFinish(boolean finish) {
        JasonOrderNumsReponser.finish = finish;
    }
